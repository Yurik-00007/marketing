...
---------------------------------------------Адаптив @media-------------------------------------------
Адаптив начинаеться с этой строчки она добовляеться автоматически и подстраивает сайт под ширину экрана устройства на котором будет открыт сайт
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">

Эта медиа запрос с условием и действием, которое означат что если ширина от 0 до 1500px значит скрой body, а если больше от 1500px условие не действует.
